  ...
  const modules = [
    {
      ...
      description: "Learn the basics of Verilog HDL and how to implement simple digital circuits.",
      level: "Beginner",
      topics: ["Verilog", "HDL", "Digital Design"],
      chapters: [{title: "Verilog Syntax", description: "Basic syntax and structure"}],
      rating: 4.9,
      students: 1250,
      exercises: [1, 2, 3, 4, 5],
    ...
    },
    {
      ...
      description: "Take your circuit design skills to the next level with advanced Verilog techniques.",
      level: "Intermediate",
      topics: ["Advanced Verilog", "Circuit Optimization", "Timing Analysis"],
      chapters: [{title: "Advanced Syntax", description: "Advanced syntax and techniques"}],
      rating: 4.7,
      students: 850,
      exercises: [1, 2, 3],
      image: "/api/placeholder/400/180"
    },
    {
      ...
      description: "Learn how to implement your designs on real FPGA hardware.",
      level: "Advanced",
      topics: ["FPGA", "Hardware", "Implementation"],
      chapters: [{title: "FPGA Basics", description: "Introduction to FPGA architecture"}],
      rating: 4.8,
      students: 620,
      exercises: [1, 2, 3, 4],
      image: "/api/placeholder/400/180"
    },
    {
      ...
      description: "Master the art of verifying complex digital systems using modern methodologies.",
      level: "Advanced",
      topics: ["Verification", "Testing", "SystemVerilog"],
      chapters: [{title: "Verification Basics", description: "Introduction to verification principles"}],
      rating: 4.6,
      students: 530,
      exercises: [1, 2],
      image: "/api/placeholder/400/180"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  {displayedModules.map(module => (
                    <div key={module.id} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow bg-white">
                      ...
                      <div className="p-4">
                        <h4 className="font-medium text-lg text-gray-900 mb-1">{module.title}</h4>
                        ...
                        <div className="border-t border-gray-100 pt-3 mt-3">
                          <div className="flex justify-between text-sm">
                            <div className="flex items-center text-yellow-500">
                              ...
                              <span className="text-gray-500 ml-1">({module.students})</span>
                            </div>
                            <div className="text-gray-500">
                              {module.chapters?.length || 0} chapters • {module.exercises?.length || 0} exercises
                            </div>
                          </div>
                        </div>
